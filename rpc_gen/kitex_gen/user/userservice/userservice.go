...
type RegisterResult struct {
	Success *user.RegisterResq
}

var RegisterResult_Success_DEFAULT *user.RegisterResq

func (p *RegisterResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.RegisterResq)
	}
...
func (p *RegisterResult) GetSuccess() *user.RegisterResq {
	if !p.IsSetSuccess() {
...
type LoginResult struct {
	Success *user.LoginResq
}

var LoginResult_Success_DEFAULT *user.LoginResq

func (p *LoginResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.LoginResq)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *LoginResult) GetSuccess() *user.LoginResq {
	if !p.IsSetSuccess() {
...
func (p *kClient) Register(ctx context.Context, Req *user.RegisterReq) (r *user.RegisterResq, err error) {
...
func (p *kClient) Login(ctx context.Context, Req *user.LoginReq) (r *user.LoginResq, err error) {
	var _args LoginArgs
	_args.Req = Req
