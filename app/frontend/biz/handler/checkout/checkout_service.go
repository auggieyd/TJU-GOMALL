...
func Checkout(ctx context.Context, c *app.RequestContext) {
	...
	c.HTML(consts.StatusOK, "checkout.tmpl", utils.WarpResponse(ctx, c, resp))
}
...
func CheckoutWaiting(ctx context.Context, c *app.RequestContext) {
	...
	c.HTML(consts.StatusOK, "waiting.tmpl", utils.WarpResponse(ctx, c, resp))
}
...
func CheckoutResult(ctx context.Context, c *app.RequestContext) {
	...
	c.HTML(consts.StatusOK, "result.tmpl", utils.WarpResponse(ctx, c, resp))
}
